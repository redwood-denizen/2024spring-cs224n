...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.zeros(self.n_features * self.embed_size, self.hidden_size))  # W
        self.embed_to_hidden_bias = nn.Parameter(torch.zeros(self.hidden_size))  # b1
        ...
        self.hidden_to_logits_weight = nn.Parameter(torch.zeros(self.hidden_size, self.n_classes))  # U
        self.hidden_to_logits_bias = nn.Parameter(torch.zeros(self.n_classes))  # b2
    ...
    def forward(self, w):
        ...
        h = nn.ReLU()(self.embedding_lookup(w) @ self.embed_to_hidden_weight + self.embed_to_hidden_bias)
